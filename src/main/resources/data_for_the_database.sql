...
INSERT INTO users (user_id, username, job_title, password, email,  role)
VALUES (1, 'test_user4', 'programmer', '$2a$12$X7yEccnTctNxzrsLI46Wn.U6zT7YZN9QaNheqpVHuYC9JXo2uL14a',
        'user1@example4.com',   'USER'),
       (2, 'admin_user4', 'notProgrammer', '$2a$12$X7yEccnTctNxzrsLI46Wn.U6zT7YZN9QaNheqpVHuYC9JXo2uL14a',
        'admin@example4.com',   'ADMIN');
