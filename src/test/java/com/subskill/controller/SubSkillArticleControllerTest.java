...
class SubSkillArticleControllerTest {
    ...
    MicroSkillDto microSkillDto1 = new MicroSkillDto(10L,"Database Design", "", "", "database_design.jpg", List.of(Tags.DESIGN), 12.0, LocalDateTime.now(), LocalDate.now(), "About Microskill", Level.ADVANCED,200, 1L);
