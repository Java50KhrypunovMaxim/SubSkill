...
import com.subskill.service.UserServiceImplementation;
...
public class SubSkillArticleControllerTest {
	...
	MicroSkillDto microSkillDto1 = new MicroSkillDto("Database Design", 4.3, "database_design.jpg");
	...
	void testDeleteArticle() throws Exception {
		...
		mockMvc.perform(delete("http://localhost:8080/api/v1/articles/delete" + ARTICLENAME3)
	...
	void testGetAllArticle() throws Exception{
		List<String> articlesList = Arrays.asList(ARTICLENAME2,ARTICLENAME1); 
		    ...
		    String jsonArticleList = mapper.writeValueAsString(articlesList);
		    String actualJSON = mockMvc.perform(get("http://localhost:8080/api/v1/users/all")
		            .contentType(MediaType.APPLICATION_JSON))
		            .andExpect(status().isOk())
		            .andReturn()
		            .getResponse()
		            .getContentAsString();
		    assertEquals(articlesList, actualJSON);
		}
